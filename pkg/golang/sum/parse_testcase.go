...
var (
	...
	// cd repo
	// go mod init github.com/org/repo
	// go get github.com/nextlinux/trivy
	// go list -m all | awk 'NR>1 {sub(/^v/, "", $2); printf("{\""$1"\", \""$2"\", },\n")}'
	GoModTrivy = []types.Library{
		...
		{Name: "github.com/nextlinux/bolt-fixtures", Version: "0.0.0-20200903104109-d34e7f983986"},
		{Name: "github.com/nextlinux/fanal", Version: "0.0.0-20210119051230-28c249da7cfd"},
		{Name: "github.com/nextlinux/go-dep-parser", Version: "0.0.0-20201028043324-889d4a92b8e0"},
		{Name: "github.com/nextlinux/go-gem-version", Version: "0.0.0-20201115065557-8eed6fe000ce"},
		{Name: "github.com/nextlinux/go-npm-version", Version: "0.0.0-20201110091526-0b796d180798"},
		{Name: "github.com/nextlinux/go-pep440-version", Version: "0.0.0-20210121094942-22b2f8951d46"},
		{Name: "github.com/nextlinux/go-version", Version: "0.0.0-20210121072130-637058cfe492"},
		{Name: "github.com/nextlinux/testdocker", Version: "0.0.0-20210106133225-0b17fe083674"},
		{Name: "github.com/nextlinux/trivy", Version: "0.16.0"},
		{Name: "github.com/nextlinux/trivy-db", Version: "0.0.0-20210105160501-c5bf4e153277"},
		{Name: "github.com/nextlinux/vuln-list-update", Version: "0.0.0-20191016075347-3d158c2bf9a2"},
