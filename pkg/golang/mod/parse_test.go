...
import (
	...
	"github.com/nextlinux/go-dep-parser/pkg/types"
)
...
func TestModuleID(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "normal",
			args: args{
				name:    "github.com/nextlinux/trivy",
				version: "0.38.0",
			},
			want: "github.com/nextlinux/trivy@v0.38.0",
		},
		{
			name: "pseudo version",
			args: args{
			...
			want: "github.com/nextlinux/go-dep-parser@v0.0.0-20230130190635-5e31092b0621",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
