...
import "github.com/nextlinux/go-dep-parser/pkg/types"

var (
	// execute go mod tidy in normal folder
	GoModNormal = []types.Library{
		{
			ID:       "github.com/nextlinux/go-dep-parser@v0.0.0-20211224170007-df43bca6b6ff",
			Name:     "github.com/nextlinux/go-dep-parser",
			Version:  "0.0.0-20211224170007-df43bca6b6ff",
			Indirect: false,
			ExternalReferences: []types.ExternalRef{
				{
					Type: types.RefVCS,
					URL:  "https://github.com/nextlinux/go-dep-parser",
				},
			},
		},
		{
	...
	GoModReplaced = []types.Library{
		{
			ID:       "github.com/nextlinux/go-dep-parser@v0.0.0-20220406074731-71021a481237",
			Name:     "github.com/nextlinux/go-dep-parser",
	...
	GoModUnreplaced = []types.Library{
		{
			ID:       "github.com/nextlinux/go-dep-parser@v0.0.0-20211110174639-8257534ffed3",
			Name:     "github.com/nextlinux/go-dep-parser",
